...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Sabotage', "Causes a flash to happen every beat.\nValue 1: Every beat where the alarm plays\nLeave the values blank to disable flashing."],
		['Change Strumline Visibility', "Makes the strumlines (notes) disappear/reappear.\nValue 1: Visible (true/false)\nValue 2: Tween Time in Beats,\ni.e 4 to tween for 4 beats\nLeave the values blank to re-enable the strumlines."],
